    ...
    public function _getNameManager($id){
        ...
        try{
            //if($where['eid']=='' || $where['oid']=='') return false;
                ...
                if ($attrib=='') $select->from("proyecto");
                else $select->from("proyecto",$attrib);
            ...
            print "Error: Read Filter proyecto ".$e->getMessage();
        }
    }
    ...
    public function _getProyectosTodosAnddes(){
        try{
            $sql=$this->_db->query("
                ...
                where not p.proyectoid in ('1590.10.01','1590.10.02','1590.10.03') order by p.proyectoid desc;
