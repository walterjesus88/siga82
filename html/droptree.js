...
selectedOption.html(treeNode.name+'<span> </span>');//La flecha desplegable span comodín 
...
selectedOption.html(nodeName+'<span> </span>');//La flecha desplegable span comodín 
