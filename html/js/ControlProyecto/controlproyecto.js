var app= angular.module('moduloCp', ['scrollable-table','ngRoute','chart.js','ui.bootstrap','ui.bootstrap.tpls','ui.router','checklist-model','dialogs','xeditable','angularFileUpload', 'datatables','highcharts-ng'])
